...
// unmount the form before the user submits. The parent must only gate on
// `selectedNote` (not live selection) so this component stays mounted while
// focus moves into the form; the frozen snapshot below is the safety net.
