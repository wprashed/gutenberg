...
-	**Supports:** align, anchor, color (background, gradients, link, text), interactivity, spacing (margin, padding)
-	**Attributes:** caption, currentTrack, order, progressColor, showArtists, showImages, showNumbers, showProgressBackground, showTrackLength, showTracklist, type, visualizationStyle
